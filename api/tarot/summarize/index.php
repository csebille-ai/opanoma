...
$tone   = strtolower(trim((string)($opts['tone']   ?? 'doux')));      // "doux"|"direct"|"positif"|"neutre"
$length = strtolower(trim((string)($opts['length'] ?? 'moyen')));     // "court"|"moyen"|"long"
$closing= isset($opts['closing']) ? (bool)$opts['closing'] : true;    // bool
